---
title: "Informe"
author: "Marco Ramirez, Alfredo Quezada, Javier Hernández"
date: "16/2/2022"
output: html_document
---

# Hoja de Trabajo: 2, Clustering
### 1. Haga el procesamiento del dataset, explique qué variables no aportan información a la generación de grupos y por qué. Describa con qué variables calculará los grupos.
...
```
# Variables a usar para el agrupamiento.
```{r wid}
...
conteoVotos<-datos2[,'voteCount']
cle<-data.frame(popularidad,presupuesto,ingresos,duracion,conteoVotos)
#cle <- datos[c("popularity","budget","revenue","runtime","voteCount")]
